...
1. 本项目代码可以用于个人或组织的商业网站、应用或服务中，但不得单独作为收费产品销售，
   包括但不限于以插件、主题、SaaS 功能包等形式直接收费或捆绑收费。

2. 允许基于本项目进行二次开发与功能扩展，但二次修改后的版本：
   - 不得以闭源形式重新发布；
   - 不得以更名、套壳、预装等方式作为独立付费插件或付费增值功能出售。

3. 允许提供围绕本项目的有偿服务，例如部署、定制开发、技术支持等，
   但收费对象应为服务本身，而非对本项目源代码的再销售。
